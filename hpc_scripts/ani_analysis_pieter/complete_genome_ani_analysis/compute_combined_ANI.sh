...
# 14-2-2014 pieter.stragier@ugent.be v0.6
...
#
# usage: compute_combined_ANI.sh <input_files> <tmp_dir> <project_name_short 4_no_spaces> <previus_output_file_not_necessary>

# define helper variables
input_files="$1"
#org tmp_dir="/home/pstragie/ANI/genomic_distance/ani_tmp"
tmp_dir="$2"
